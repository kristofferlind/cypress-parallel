...
/*
  Runner events in reporter seem to be pretty reliable, passing them via logs however wasn't
  passing statistics on in more of the events helped make it a bit more reliable, but we
  still had issues with intermittent missing results in totals.

  Writing results to files instead should be a bit more reliable

  If we skip logbased communication it might also be an option to just pipe all output
*/
